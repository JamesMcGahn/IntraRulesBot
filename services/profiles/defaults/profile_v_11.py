...
v_11 = BrowserProfile(
    ...
    selectors=ExecutorSelectors(
        ...
        queues=QueueSelectors(
            ...
            queue_add_button="#ctl00_overlayContent_rbAdd",
            queue_grid_container='[id*="RadLoadingPanelctl00_overlayContent_gridACDQueues"]',
            queue_grid_rows="""[id*="gridACDQueues_GridData"] tr.rgRow,[id*="gridACDQueues_GridData"] tr.rgAltRow""",
        ...
        triggers=TriggerSelectors(
            ...
            details={
                ...
                ACTIONTRIGGERDETAILTYPE.TIME_IN_STATE: TriggerTimeInStateSelectors(
                    ...
                    aux_equality_operator_dropdown_arrow='[id*="ctl00_overlayContent_triggerParameters_ctl44_Arrow"],[id*="ctl00_overlayContent_triggerParameters_ctl19_Arrow"]',
                    aux_equality_operator_dropdown_items='//*[contains(@id, "ctl00_overlayContent_triggerParameters_ctl44_DropDown")]/div/ul/li | //*[contains(@id, "ctl00_overlayContent_triggerParameters_ctl19_DropDown")]/div/ul/li',
                    aux_input='[id*="ctl00_overlayContent_triggerParameters_ctl46"], [id*="ctl00_overlayContent_triggerParameters_ctl21"]',
                ),
        ...
        conditions=ConditionSelectors(
            ...
            details={
                ...
                CONDITIONDETAILTYPE.SEGMENT_CODES: ConditionWFMSegmentCodes(
                    equality_operator_dropdown_arrow='[id*="ctl00_overlayContent_conditionParameters_ddExposedDataOperator_Arrow"]',
                    equality_operator_dropdown_items='//*[contains(@id, "ctl00_overlayContent_conditionParameters_ddExposedDataOperator_DropDown")]/div/ul/li',
                    segment_code_dropdown_arrow='[id*="ctl00_overlayContent_conditionParameters_ddSegmentCodesSelector_Arrow"]',
                    segment_code_dropdown_items='//*[contains(@id, "ctl00_overlayContent_conditionParameters_ddSegmentCodesSelector_DropDown")]/div/ul/li',
                    match_mode_any_radio='[id*="overlayContent_conditionParameters_rblAnyAllSegmecodes_0"]',
                    match_mode_all_radio='[id*="overlayContent_conditionParameters_rblAnyAllSegmecodes_1"]',
                    time_interval_duration_radio='[id*="overlayContent_conditionParameters_ctl11_0"]',
                    time_interval_start_end_radio='[id*="overlayContent_conditionParameters_ctl11_1"]',
                    start_time_dropdown_arrow='[id*="ctl00_overlayContent_conditionParameters_ctl18_Arrow"]',
                    start_time_dropdown_items='//*[contains(@id, "ctl00_overlayContent_conditionParameters_ctl18_DropDown")]/div/ul/li',
                    duration_input='[id*="overlayContent_conditionParameters_ctl31"]',
                    segment_occurrence_dropdown_arrow='[id*="ctl00_overlayContent_conditionParameters_ctl44_Arrow"]',
                    segment_occurrence_dropdown_items='//*[contains(@id, "ctl00_overlayContent_conditionParameters_ctl44_DropDown")]/div/ul/li',
                    end_time_dropdown_arrow='[id*="ctl00_overlayContent_conditionParameters_ctl37_Arrow"]',
                    end_time_dropdown_items='//*[contains(@id, "ctl00_overlayContent_conditionParameters_ctl37_DropDown")]/div/ul/li',
                    user_list_arrow='[id*="user_filter_static_id_Arrow"]',
                    user_list_items='//*[contains(@id, "user_filter_static_id_DropDown")]/div/ul/li',
                ),
            },
