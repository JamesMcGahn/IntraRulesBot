...
from ....rules.models.conditions import Condition, ConditionStatsDetails
...
class ConditionsStatsExecutor(
    BaseChildDetailedExecutor[ConditionStatsDetails, ConditionDetailSelectors]
):
    """
    ...
    def __init__(
        ...
        item_context: ExecutorItemContext[Condition[ConditionStatsDetails]],
    ):
        super().__init__(
